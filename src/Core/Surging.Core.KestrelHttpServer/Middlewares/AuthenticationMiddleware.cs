    ...
    public class AuthenticationMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext context)
        {
            ...
            catch (AuthenticationException ex)
            {
                ...
                await context.Response.WriteAsync(JsonConvert.SerializeObject(noAuthResponseContent, new JsonSerializerSettings()
                {
            ...
            catch (CPlatformException ex)
            {
                ...
                await context.Response.WriteAsync(JsonConvert.SerializeObject(resultMessage,new JsonSerializerSettings() {
                    ContractResolver = new CamelCasePropertyNamesContractResolver()
            }));
            }
            catch (Exception ex)
